# Retrieval Graph Walker

> Walk retrieval graphs for multi-hop QA

**Author:** zAx4hub

## Problem

Walk retrieval graphs for multi-hop QA. Teams often rely on closed SaaS, brittle scripts, or untested prototypes for this niche.

## Solution

`retrieval-graph-walker` is an installable TypeScript/Node toolkit by **zAx4hub** with a real **routing** engine, CLI, examples, and tests.
